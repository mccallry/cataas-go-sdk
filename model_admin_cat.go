...
// checks if the AdminCat type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AdminCat{}

// AdminCat struct for AdminCat
...
func (o AdminCat) MarshalJSON() ([]byte, error) {
...
func (o AdminCat) ToMap() (map[string]interface{}, error) {
...
func (o *AdminCat) UnmarshalJSON(data []byte) (err error) {
	...
	varAdminCat := _AdminCat{}

	err = json.Unmarshal(data, &varAdminCat)

	if err != nil {
		return err
	}

	*o = AdminCat(varAdminCat)
...
type NullableAdminCat struct {
	value *AdminCat
	isSet bool
}

func (v NullableAdminCat) Get() *AdminCat {
	return v.value
}

func (v *NullableAdminCat) Set(val *AdminCat) {
	v.value = val
	v.isSet = true
}

func (v NullableAdminCat) IsSet() bool {
	return v.isSet
}

func (v *NullableAdminCat) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAdminCat(val *AdminCat) *NullableAdminCat {
	return &NullableAdminCat{value: val, isSet: true}
}

func (v NullableAdminCat) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAdminCat) UnmarshalJSON(src []byte) error {
	v.isSet = true
